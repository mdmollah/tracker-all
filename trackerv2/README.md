...
```xml
<dependency>
    <groupId>com.swift.tracker</groupId>
    <artifactId>tracker-v2</artifactId>
...
```groovy
compile "com.swift.tracker:tracker-v2:1.0.0"
```
...
import com.swift.tracker.trackerv2.*;
import com.swift.tracker.trackerv2.auth.*;
